  ...
  <div>
    ...
    <div class="table-content">
      ...
      >
        ...
        <el-table-column label="订单编号" prop="code" align="center">
        ...
        <el-table-column  label="操作" align="center" width="150">
          <template slot-scope="scope">
            <a @click.prevent="copy(scope.row.id)" style="padding:0 7px;cursor: pointer;color:#44B549;">详情</a>
            <a @click.prevent style="padding:0 7px;color:#44B549;cursor: pointer">付款</a>           
          </template>
        </el-table-column>
      </el-table>
    </div>
...
export default {
  ...
  methods: {
    tabHandle(id) {
      this.$router.push({
        path: "/company/service_orders/index",
        query: {
          id: id
        }
      });
